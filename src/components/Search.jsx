  ...
  return (
    <div className="search relative h-[65rem] px-[5rem] bg-[#081730] pt-[18rem] pt-[18rem] pb-[10rem] mt-[-15rem] z-[1] flex items-center justify-between round-b-[5rem]">
        ...
        <div className="left flex-1">
            ...
            alt=""
            className='absolute top-[22rem] right-[47rem]'
            />
                        <img
            src={require("../img/d1.png")}
            alt=""
            className='absolute w-[16rem] top-[26rem] absolute'
            />{" "}
                        <img
                ...
                <div className="searchbar flex justify-start w-[100%]">
                 ...
                 <div className="detail flex flex-col mt-5 text-4xl">
                     ...
                     <span className='text-sm mt-3 text-[#4D586A]'>
                         Lorem ipsum dolor sit amet, consectetur <br/> adipisicing elit. Eligendi dolor <br/> harum expedita!
                     </span>
